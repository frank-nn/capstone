...
export default function Profile() {
  ...
  // 🔁 Choose cover image based on email
  const getCoverImage = (email) => {
    if (email === "jack@email.com") return "/assets2/coverpic.jpeg";
    return "/assets2/cover.jpg"; // default
  };
